...
\title{Snort\texttrademark  Users Manual\\  2.8.3.1 }
...
\begin{note}
The Stream4 preprocessor will be deprecated in a future release.
\end{note}
...
\begin{note}
The flow preprocessor will be deprecated in a future release.
\end{note}
